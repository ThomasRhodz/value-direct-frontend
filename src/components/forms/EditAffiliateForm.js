...
const EditAffiliateForm = ({ onClose, id, name, acronym, toast }) => {
  const [companyName, setCompanyName] = React.useState(name);
  const [companyAcronym, setCompanyAcronym] = React.useState(acronym);
  ...
  return (
    <Grid>
      <Stack direction="column" alignItems="center" sx={{ width: "100%" }}>
        <Grid item>
          <DialogTitle>Edit Affiliate Form</DialogTitle>
        </Grid>
      ...
      <form style={{ width: "100%" }} onSubmit={handleSubmit(onSubmit)}>
        <Grid
          ...
          direction="column"
          alignItems="center"
          sx={{ width: { xs: 330, sm: 360, md: 400 }, padding: 2 }}
        >
          <div style={{ height: 15 }} />

...
const NewAffiliateUserForm = ({ onClose, toast }) => {
  ...
  const [user_company, setCompany] = React.useState(1);
    ...
    if (contact_number!==''){
      if (contact.findIndex((c) => c.number === contact_number) === -1){
        ...
        if (!contactLimit) {
          ...
          console.log('Only 4 contacts is allowed.')
        }
      }else{
        console.log('Contact number already exist')
      }
    }else{
      console.log('Input your contact number')
    }
        ...
        >
          ...
          <Stack direction='row'>
            <Stack direction='column' sx={{ maxWidth:350 }}>
              ...
              <Grid item sx={{ width: "100%" }}>
                <FormControl variant="outlined" sx={{ width: "100%" }}>
                  ...
                  >
                    <MenuItem value={1}>IND Legal Services</MenuItem>
                    <MenuItem value={2}>Mass Tort Alliance</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
            ...
            <Stack direction='column' sx={{ width:380 }}>
              ...
              <div style={{ height: 15 }} />
              <Grid sx={{ backgroundColor:"#D9D9D9", borderRadius:1, p:2, pb:3, maxHeight:250, overflowY:'scroll'}}>
...
export default NewAffiliateUserForm;
